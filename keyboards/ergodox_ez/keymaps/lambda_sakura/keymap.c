 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Ctl    | A/L1 |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|  Enter |
 * |--------+------+------+------+------+------| \    |           | '    |------+------+------+------+------+--------|
 * | ~L1    |Z/Ctl |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |  /   |  ~L1   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|      |      | LAlt |LGui  |                                       | Bksp | Del  |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | DEL  | Alt  |       | Alt  | Ctrl |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV), KC_DOWN,     KC_UP,  KC_LALT, KC_LGUI,
                                                                KC_DEL,    KC_LALT,
                                                                           KC_ESC,
                                                        KC_SPC, KC_RSFT,   KC_ESC,
        // right hand
        ...
        KC_QUOT,    KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH,           KC_RSFT,
                             KC_BSPC,  KC_DEL,  KC_LEFT, KC_RIGHT,           KC_FN1,
        KC_RCTL, KC_RALT,
        KC_PGUP,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_NO,  KC_CIRC,   KC_AMPR,  KC_NO,   KC_NO,    KC_EQL,   KC_F12,
               KC_ASTR,   KC_PLUS,  KC_NO,   KC_UP,    KC_QUOT,  KC_DQT,
       KC_NO,  KC_MINUS,  KC_EQL,   KC_LEFT, KC_DOWN,  KC_RGHT,  KC_TRNS,
                          KC_TRNS,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,
       RGB_TOG, RGB_SLD,
       KC_TRNS,
